...
/**
 * Will sign a message with a given bellcoin private key.
 *
...
/**
 * Will return a boolean of the signature is valid for a given bellcoin address.
 * If it isn't the specific reason is accessible via the "error" member.
 *
 * @param {Address|String} bellcoinAddress - A bellcoin address
